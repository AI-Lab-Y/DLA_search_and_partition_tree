...
if __name__ == '__main__':
    pos = 25
    hw = 4
    DLAs_with_high_cor = np.load('./diff{}_5r_hw{}_DLAs_with_high_cor.npy'.format(pos, hw),
                                 allow_pickle=True)
    ...
    s1 = compute_space_size(bit_num=block_size, hw=hw)
    s2 = compute_space_size(bit_num=len(active_bits), hw=hw)
