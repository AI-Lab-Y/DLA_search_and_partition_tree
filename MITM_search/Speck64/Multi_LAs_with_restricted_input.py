...
(1) the weight of absolute correlation is lower or equal than the UpperBound
...
then we advise that the bit_bias_bound (i.e., the weight of absolute correlation)
...
bit_bias_bound = 8
diff_index = 63         # set the one bit difference $\varDelta _m$
...
SearchRoundEnd = 5
InitialLowerBound = 0
# the upper bound of the cor of the linear trail
UpperBound = 6
...
# main function
folder = './linear_hulls/cor_w_{}/diff_{}/{}_round/'.format(UpperBound, diff_index, SearchRoundStart)
