...
def verify_experimental_cor(n=2**32, nr=5, diff=(0x40, 0x0), mask=(0x40, 0x0), fixedKey=1):
    if fixedKey == 1:
        t = 100
...
# besides, in Stage 3, the correlation of DLAs is firstly evaluated under free key setting.
nr = 6 + 0
diff = (1 << (53 - word_size), 0)
...
mask = (v0, v1)
print('diff is [{}], linear mask is {}'.format(53, indexs))
